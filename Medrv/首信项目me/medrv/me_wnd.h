...
// ME_SMS_SEND
#if defined TI_MODULE || defined WAVECOM_2C
...
#else
enum sms_type { TEXT_SMS, DATA_SMS, SUBMIT_REPORT, STATUS_REPORT, SMS_DELIVER };
typedef struct tagSMS_Send
{
	char	SCA[ME_PHONENUM_LEN];
	int		Type;
...
typedef struct tagSMSMem_Info
{
	...
	int		nMem2Used;
	int		nMem2Total;
#if defined SIEMENS_TC35 || defined TI_MODULE || defined INFINION_MODULE
	int		nMem3Used;
	int		nMem3Total;
#endif
...
#if defined WAVECOM_2C || defined TI_MODULE || defined INFINION_MODULE
